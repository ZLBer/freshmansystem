...
<body>
<br><br><br>
<form method="post" name="colquery">
    ...
    <br><br><br>
    <a href="javascript:document.colquery.action='CollegeQueryBySno';document.colquery.submit();" class="weui-btn weui-btn_primary">确定</a>
    <br><br><br>
</form>
</body>
</html>
