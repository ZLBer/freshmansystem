...
<body>
<form action="${pageContext.request.contextPath }/admin/queryByAdmin" method="post" id="query">
    ...
    <table border="1" frame="void" class="easyui-datagrid" id="content"
        ...
        <c:forEach items="${studentList}" var="stu">
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath }/admin/view.jsp?sno=${stu[0]}">查看</a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
