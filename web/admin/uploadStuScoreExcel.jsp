...
<center>
    ...
    <form id="file_form" action="${pageContext.request.contextPath}/admin/uploadStuScoreServlet" enctype="multipart/form-data" method="post">
    ...
    <p><a  href="student-info-example.xlsx">下载导入学生分数模板表格(.xlsx)</a></p>
</center>
</body>
</html>
