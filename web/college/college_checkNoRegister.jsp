...
<table border="1" frame="void" class="easyui-datagrid" id="content"
   ...
   <thead>
    ...
    <c:forEach var="student" begin="${(page_current-1)*page_size}" end="${page_current*page_size-1}" items="${students}">
        ...
        <a href = "college_checkNoRegister?page_current=1&collegeid=${user.college}" >首页</a>&nbsp;
        <a href = "college_checkNoRegister?page_current=${page_current-1}&collegeid=${user.college}" >上一页</a>&nbsp;
        <a href = "college_checkNoRegister?page_current=${page_current+1}&collegeid=${user.college}" >下一页</a>&nbsp;
        <a href = "college_checkNoRegister?page_current=${page_count}&collegeid=${user.college}" >尾页</a>&nbsp;
