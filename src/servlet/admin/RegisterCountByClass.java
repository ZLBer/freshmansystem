...
public class RegisterCountByClass extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for(Object a:classlist){
            ...
            final String CONDITION = "WHERE b.classNum='"+classes+"' and b.major='"+majorname +"' and b.college='"+collegename+"' and b.sno=r.sno";
            float mcount = recordCount(tableAlias,CONDITION);
            final String CONDI = "WHERE b.classNum='"+classes+"' and b.major='"+majorname +"' and b.college='"+collegename+"' and b.sno=r.sno and r.spotRegister='已报到'";
        ...
        if(session.getAttribute("userid")!=null){
            request.getRequestDispatcher("/WEUI/admin/registercountbyclass.jsp").forward(request, response);
        }else {
