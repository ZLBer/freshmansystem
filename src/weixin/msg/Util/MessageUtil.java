...
public class MessageUtil {
    ...
    public static Map<String, String> parseXml(File files) throws Exception {
        // 将解析结果存储在HashMap中
        Map<String, String> map = new HashMap<String, String>();
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map<String,String> map1 = parseXml(file);
        System.out.println(map1.get("ScanResult"));
    }
    /*
     * 文本消息对象转换成xml
     *
