...
public class MUDload {
	...
	public static String getMediaIdurl="https://qyapi.weixin.qq.com/cgi-bin/material/batchget?access_token=ACCESS_TOKEN";
	 ...
	 * 获取media_id
	 */
	public static String getMedia_id(String type){
		String PostData="{\"type\": %S,\"offset\":\"0\",\"count\":\"1\"}";
		type="\""+type+"\"";
		return String.format(PostData,type);
	}
	//示例
