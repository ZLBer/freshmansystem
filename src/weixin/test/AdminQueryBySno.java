...
/**
 * Created by ThinkPad on 2017/5/31 0031.
 */
public class AdminQueryBySno extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

        String fieldValue = request.getParameter("fieldValue");       //学号

        String condi = " and basicinfo.sno=" + fieldValue;
        ...
        if (studentlist.size() > 0) {
            ...
            request.getRequestDispatcher("/WEUI/admin/querystudent_info.jsp").forward(request, response);
        }
        else{
