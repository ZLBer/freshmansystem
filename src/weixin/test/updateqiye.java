...
public class updateqiye extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(0==result){
            ...
            response.sendRedirect("http://www.speedlyh.cn/sdauweixin/WEUI/operate_success.jsp");
        }
        else {
            System.out.println("修改失败");
            response.sendRedirect("http://www.speedlyh.cn/sdauweixin/WEUI/operate_fail.jsp");
        }
        out.close();
    }
